public class libros{
    ...
    public double costo_prestamo, total;
    ...
    public libros(String titulo, String autor, String isbn, String genero, int ejemplares, double costo_prestamo, double total){
        this.titulo = titulo;
        this.autor = autor;
        this.isbn = isbn;
        this.genero = genero;
